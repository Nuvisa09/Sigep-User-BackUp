...
class PagerContent extends StatelessWidget {
  const PagerContent({super.key, required this.image, required this.text, required this.subText, required this.topImage, this.topImageHeight, this.topImageWidth}) ;
  final String image;
  final String text;
                ...
                Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraMoreLarge),
                  child: Column(mainAxisSize: MainAxisSize.min,children: [
                    ...
                    Text(text,
                      ...
                      style: robotoBold.copyWith(color: Theme.of(context).colorScheme.primary, fontSize: 23),
                    ),
