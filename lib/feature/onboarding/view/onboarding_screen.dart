            ...
            Expanded(
              child: PageView.builder(
                ...
                itemBuilder: (context, index) => PagerContent(
                  ...
                  topImageHeight: double.tryParse(
                      onBoardingController.onBoardPagerData[index]["top_image_height"] ?? ""
                  ) ?? 200,
                  topImageWidth: double.tryParse(
                      onBoardingController.onBoardPagerData[index]["top_image_width"] ?? ""
                  ),
                ),
              ),
            ),
