...
class AppConstants {
  ...
  static const String appName = 'sigep';
  static const String appVersion = '3.2'; /// Flutter SDK : 3.29.3
  static const String baseUrl = 'https://man.orderjasa.com';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.indonesia, languageName: 'Indonesia', countryCode: 'ID', languageCode: 'id'),
  ];
